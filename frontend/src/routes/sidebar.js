...
const routes = [
...

  {
    ...
    name: 'Restaurants', // name that appear in Sidebar
    submenu : [
      {
        path: '/app/leads', // url
  ...
  {
    path: '', //no url needed as this has submenu
    icon: <MenuBookIcon className={`${iconClasses} inline` }/>, // icon component
    ...
    submenu : [
      ...
      
      {
        path: '/app/settings-profile', //url
        icon: <UserIcon className={submenuIconClasses}/>, // icon component
        name: 'Add Menu Item', // name that appear in Sidebar
      },
    ]
  },
